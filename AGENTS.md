...
- `gaze-recognizers` — regex/dictionary/NER detection backends + embedded rulepacks, plus the opt-in safety-net backends (OPF subprocess and the in-process Nym-small net behind `safety-net-nym`). No safety net runs by default.
