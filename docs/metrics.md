...
[`docs/architecture/ambiguity-side-channel.md`](architecture/ambiguity-side-channel.md),
[`docs/architecture/validator-veto.md`](architecture/validator-veto.md),
[`docs/architecture/collision-family.md`](architecture/collision-family.md),
[`docs/architecture/safety-net-modes.md`](architecture/safety-net-modes.md).
...
[`docs/architecture/validator-veto.md`](architecture/validator-veto.md),
[`docs/architecture/collision-family.md`](architecture/collision-family.md),
[`docs/architecture/anchor-resolution.md`](architecture/anchor-resolution.md),
[`docs/architecture/safety-net-modes.md`](architecture/safety-net-modes.md).
...
See [`docs/architecture/safety-net-benchmark.md`](architecture/safety-net-benchmark.md).
...
Methodology: [`docs/research/v0.8-kiji-benchmark.md`](research/v0.8-kiji-benchmark.md).
Class-gap reference: [`docs/research/v0.8-kiji-class-gap.md`](research/v0.8-kiji-class-gap.md).
...
([`safety-net-benchmark.md`](architecture/safety-net-benchmark.md)).
...
deployments (see [`safety-net-modes.md`](architecture/safety-net-modes.md)
§3).
...
[`docs/architecture/locale-chain.md`](architecture/locale-chain.md). The
...
[`docs/architecture/safety-nets.md`](architecture/safety-nets.md) §"Trait shape".
...
- [`docs/architecture/ambiguity-side-channel.md`](architecture/ambiguity-side-channel.md) — `ambiguity_record`, `validator_fail_reason`, `collision_*` schema.
- [`docs/architecture/validator-veto.md`](architecture/validator-veto.md) — `ConflictTier::ValidatorVeto` semantics.
- [`docs/architecture/collision-family.md`](architecture/collision-family.md) — `CollisionMembership`, `ConflictTier::CollisionPolicy`.
- [`docs/architecture/anchor-resolution.md`](architecture/anchor-resolution.md) — `mandatory_anchor`, `ConflictTier::AnchoredContext`.
- [`docs/architecture/safety-nets.md`](architecture/safety-nets.md) — Pass-3 observer contract, trait shape, manifest invariants.
- [`docs/architecture/safety-net-modes.md`](architecture/safety-net-modes.md) — `resolve` / `redact` / `fallback` modes and `decided_by` extensions.
- [`docs/architecture/safety-net-benchmark.md`](architecture/safety-net-benchmark.md) — `safety_net_matrix` snapshot pins + matrix shape.
- [`docs/architecture/mcp-runtime.md`](architecture/mcp-runtime.md) — `ToolCtx` seal, dispatch ordering, manifest persistence.
- [`docs/architecture/document-extension.md`](architecture/document-extension.md) — signed snapshot envelope.
- [`docs/architecture/locale-chain.md`](architecture/locale-chain.md) — 4-tier locale resolution.
- [`docs/architecture/feedback-loop.md`](architecture/feedback-loop.md) — resolve-mode promotion plumbing.
