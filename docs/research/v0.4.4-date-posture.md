...
GH issue #5 (https://github.com/EmpireTwo/gaze/issues/5) raised concern about date redaction trade-offs: relative-distance preservation and locale ambiguity. This memo resolves that concern as:
...
- An adopter reports DOB leak in the production pipeline with concrete fixture.
