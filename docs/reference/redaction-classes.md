...
| `core, core-extended` | `phone.national.us` | `regex` | US NANPA phone shapes, including the documented synthetic 555-01xx range | `custom:phone` | `en-US` | `e164_phone_national_us` | `none` | `locale_gated` | no | 0.82 | 85 | `crates/gaze-recognizers/embedded/core.toml:251-278` |
...
| `core, core-extended` | `vat.de` | `regex` | Cue-anchored German VAT identifiers shaped as DE followed by nine digits | `custom:vat_id` | `de-DE, de-AT, de-CH` | `none` | `none` | `locale_gated` | no | 0.88 | 86 | `crates/gaze-recognizers/embedded/core.toml:490-509` |
| `core, core-extended` | `vat.es` | `regex` | Cue-anchored Spanish VAT, CIF, or NIF identifiers in the ES alphanumeric shape | `custom:vat_id` | `es-ES` | `none` | `none` | `locale_gated` | no | 0.84 | 84 | `crates/gaze-recognizers/embedded/core.toml:511-530` |
...
| `core, core-extended` | `ssn.us` | `regex` | Cue-anchored US Social Security numbers in dashed or nine-digit form | `custom:ssn` | `en-US` | `none` | `none` | `locale_gated` | no | 0.88 | 86 | `crates/gaze-recognizers/embedded/core.toml:616-632` |
| `core, core-extended` | `nino.uk` | `regex` | Cue-anchored UK National Insurance numbers with allocation-constrained prefixes | `custom:nino` | `en-GB` | `none` | `none` | `locale_gated` | no | 0.88 | 86 | `crates/gaze-recognizers/embedded/core.toml:634-653` |
