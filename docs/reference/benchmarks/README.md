...
| [v0.12-3025g-e35d24d-scorecard.md](v0.12-3025g-e35d24d-scorecard.md) | #3025 slice G: shared cue→value connector grammar for the five SSN / government-ID recognizers at `e35d24d` against the slice-U merge `56e1a3d`, with the span-by-span changed-outcome set and the four Kiji re-segmentation residuals named | Current evidence |
| [v0.12-3025g-e35d24d-candidate-scorecard-v4.json](v0.12-3025g-e35d24d-candidate-scorecard-v4.json) | Schema-v4 CANDIDATE scorecard (`e35d24d`, run 1) for the slice-G comparison; BASE is U's committed `bfcf264` scorecard, whose runtime tree equals `56e1a3d` (not an accepted baseline) | Current evidence |
| [v0.12-3025g-e35d24d-candidate-run2-scorecard-v4.json](v0.12-3025g-e35d24d-candidate-run2-scorecard-v4.json) | Second full CANDIDATE run (`e35d24d`), the two-run determinism evidence for the slice-G comparison (not an accepted baseline) | Current evidence |
