...
[`docs/reference/benchmarks/v0.9-safety-net-benchmark.md`](v0.9-safety-net-benchmark.md).
The historical Kiji-only anchor remains in
[`docs/reference/benchmarks/v0.8-kiji-benchmark.md`](v0.8-kiji-benchmark.md).
