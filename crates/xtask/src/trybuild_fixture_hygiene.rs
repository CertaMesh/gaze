...
const ROOT_EXPECTATIONS: &[&str] = &[
    ...
    "crates/gaze-mcp-core/tests/ui/tier/agent_tier_must_not_reach_export_session_tokens.stderr",
    "crates/gaze-mcp-core/tests/ui/tier/agent_tier_must_not_reach_operator_tools_reexport.stderr",
    "crates/gaze-mcp-core/tests/ui/tier/agent_tier_must_not_reach_restore.stderr",
    "crates/gaze-mcp-core/tests/ui/tier/agent_tier_must_not_reach_restore_strict.stderr",
